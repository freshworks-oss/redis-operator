...
// EnsureNotPresentRedisSlaveService provides a mock function with given fields: rFailover
func (_m *RedisFailoverClient) EnsureNotPresentRedisSlaveService(rFailover *v1.RedisFailover) error {
	ret := _m.Called(rFailover)

	if len(ret) == 0 {
		panic("no return value specified for EnsureNotPresentRedisSlaveService")
	}
